...
from hotel_management.factories import UserFactory, HotelFactory, RoomFactory, LocationFactory
...
class ReviewTestCase(APITestCase):
    def setUp(self):
        ...
        self.hotel = HotelFactory.create(user=self.admin, location=LocationFactory.create())
        ...
        self.abstract_review_build = AbstractReviewFactory.build(user=self.admin, content_type=self.content_type,
    ...
    def test_post_hotel_review_unauthorized_user(self):
        ...
        post_review = self.client.post(reverse('reviews-management:reviews-list'), abstract_review, format='json')
    ...
    def test_post_hotel_review_authorized_user(self):
        ...
        post_review = self.client.post(reverse('reviews-management:reviews-list'), request, format='json')
